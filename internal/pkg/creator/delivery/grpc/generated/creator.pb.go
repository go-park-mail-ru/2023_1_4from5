...
var file_creator_proto_rawDesc = []byte{
	...
	0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x88,
	0x0d, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x79, 0x22, 0x00, 0x12, 0x34, 0x0a, 0x0f, 0x49, 0x73, 0x50, 0x6f, 0x73, 0x74, 0x41, 0x76, 0x61,
	0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x10, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x0d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x42, 0x2e, 0x5a, 0x2c, 0x69, 0x6e, 0x74,
...
var file_creator_proto_depIdxs = []int32{
	...
	5,  // 42: CreatorService.IsPostAvailable:input_type -> PostUserMessage
	2,  // 43: CreatorService.FindCreators:output_type -> CreatorsMessage
	7,  // 44: CreatorService.GetPage:output_type -> CreatorPage
	22, // 45: CreatorService.UpdateCreatorData:output_type -> common.Empty
	10, // 46: CreatorService.GetFeed:output_type -> PostsMessage
	2,  // 47: CreatorService.GetAllCreators:output_type -> CreatorsMessage
	14, // 48: CreatorService.IsCreator:output_type -> FlagMessage
	22, // 49: CreatorService.CreateAim:output_type -> common.Empty
	24, // 50: CreatorService.CheckIfCreator:output_type -> common.UUIDResponse
	22, // 51: CreatorService.CreatePost:output_type -> common.Empty
	11, // 52: CreatorService.GetPost:output_type -> PostMessage
	22, // 53: CreatorService.DeletePost:output_type -> common.Empty
	14, // 54: CreatorService.IsPostOwner:output_type -> FlagMessage
	14, // 55: CreatorService.IsCommentOwner:output_type -> FlagMessage
	19, // 56: CreatorService.AddLike:output_type -> Like
	19, // 57: CreatorService.RemoveLike:output_type -> Like
	22, // 58: CreatorService.EditPost:output_type -> common.Empty
	22, // 59: CreatorService.DeleteAttachmentsFiles:output_type -> common.Empty
	22, // 60: CreatorService.DeleteAttachmentsByPostID:output_type -> common.Empty
	22, // 61: CreatorService.DeleteAttachment:output_type -> common.Empty
	22, // 62: CreatorService.AddAttach:output_type -> common.Empty
	15, // 63: CreatorService.GetFileExtension:output_type -> Extension
	24, // 64: CreatorService.UpdateProfilePhoto:output_type -> common.UUIDResponse
	22, // 65: CreatorService.DeleteProfilePhoto:output_type -> common.Empty
	24, // 66: CreatorService.UpdateCoverPhoto:output_type -> common.UUIDResponse
	22, // 67: CreatorService.DeleteCoverPhoto:output_type -> common.Empty
	22, // 68: CreatorService.CreateSubscription:output_type -> common.Empty
	22, // 69: CreatorService.DeleteSubscription:output_type -> common.Empty
	22, // 70: CreatorService.EditSubscription:output_type -> common.Empty
	22, // 71: CreatorService.CreateComment:output_type -> common.Empty
	22, // 72: CreatorService.DeleteComment:output_type -> common.Empty
	22, // 73: CreatorService.IsPostAvailable:output_type -> common.Empty
