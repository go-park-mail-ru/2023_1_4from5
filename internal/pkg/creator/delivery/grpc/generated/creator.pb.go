...
var file_creator_proto_rawDesc = []byte{
	...
	0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xb9,
	0x0b, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6f, 0x6e, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x42, 0x2e, 0x5a, 0x2c, 0x69, 0x6e,
...
var file_creator_proto_depIdxs = []int32{
	...
	2,  // 39: CreatorService.FindCreators:output_type -> CreatorsMessage
	7,  // 40: CreatorService.GetPage:output_type -> CreatorPage
	22, // 41: CreatorService.UpdateCreatorData:output_type -> common.Empty
	10, // 42: CreatorService.GetFeed:output_type -> PostsMessage
	2,  // 43: CreatorService.GetAllCreators:output_type -> CreatorsMessage
	14, // 44: CreatorService.IsCreator:output_type -> FlagMessage
	22, // 45: CreatorService.CreateAim:output_type -> common.Empty
	23, // 46: CreatorService.CheckIfCreator:output_type -> common.UUIDResponse
	22, // 47: CreatorService.CreatePost:output_type -> common.Empty
	11, // 48: CreatorService.GetPost:output_type -> PostMessage
	22, // 49: CreatorService.DeletePost:output_type -> common.Empty
	14, // 50: CreatorService.IsPostOwner:output_type -> FlagMessage
	19, // 51: CreatorService.AddLike:output_type -> Like
	19, // 52: CreatorService.RemoveLike:output_type -> Like
	22, // 53: CreatorService.EditPost:output_type -> common.Empty
	22, // 54: CreatorService.DeleteAttachmentsFiles:output_type -> common.Empty
	22, // 55: CreatorService.DeleteAttachmentsByPostID:output_type -> common.Empty
	22, // 56: CreatorService.DeleteAttachment:output_type -> common.Empty
	22, // 57: CreatorService.AddAttach:output_type -> common.Empty
	15, // 58: CreatorService.GetFileExtension:output_type -> Extension
	23, // 59: CreatorService.UpdateProfilePhoto:output_type -> common.UUIDResponse
	22, // 60: CreatorService.DeleteProfilePhoto:output_type -> common.Empty
	23, // 61: CreatorService.UpdateCoverPhoto:output_type -> common.UUIDResponse
	22, // 62: CreatorService.DeleteCoverPhoto:output_type -> common.Empty
	22, // 63: CreatorService.CreateSubscription:output_type -> common.Empty
	22, // 64: CreatorService.DeleteSubscription:output_type -> common.Empty
	22, // 65: CreatorService.EditSubscription:output_type -> common.Empty
