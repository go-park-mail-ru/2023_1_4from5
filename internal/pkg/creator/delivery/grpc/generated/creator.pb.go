...
var file_creator_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x6f, 0x72, 0x32, 0x83, 0x08, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72,
	...
	0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x00, 0x42, 0x2e, 0x5a, 0x2c, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x6f, 0x72, 0x2f, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x2f, 0x67, 0x72, 0x70, 0x63,
...
var file_creator_proto_depIdxs = []int32{
	...
	2,  // 32: CreatorService.FindCreators:output_type -> CreatorsMessage
	6,  // 33: CreatorService.GetPage:output_type -> CreatorPage
	21, // 34: CreatorService.UpdateCreatorData:output_type -> common.Empty
	9,  // 35: CreatorService.GetFeed:output_type -> PostsMessage
	2,  // 36: CreatorService.GetAllCreators:output_type -> CreatorsMessage
	13, // 37: CreatorService.IsCreator:output_type -> FlagMessage
	21, // 38: CreatorService.CreateAim:output_type -> common.Empty
	22, // 39: CreatorService.CheckIfCreator:output_type -> common.UUIDResponse
	21, // 40: CreatorService.CreatePost:output_type -> common.Empty
	10, // 41: CreatorService.GetPost:output_type -> PostMessage
	21, // 42: CreatorService.DeletePost:output_type -> common.Empty
	13, // 43: CreatorService.IsPostOwner:output_type -> FlagMessage
	18, // 44: CreatorService.AddLike:output_type -> Like
	18, // 45: CreatorService.RemoveLike:output_type -> Like
	21, // 46: CreatorService.EditPost:output_type -> common.Empty
	21, // 47: CreatorService.DeleteAttachmentsFiles:output_type -> common.Empty
	21, // 48: CreatorService.DeleteAttachmentsByPostID:output_type -> common.Empty
	21, // 49: CreatorService.DeleteAttachment:output_type -> common.Empty
	21, // 50: CreatorService.AddAttach:output_type -> common.Empty
	14, // 51: CreatorService.GetFileExtension:output_type -> Extension
