...
import (
	...
	"github.com/go-park-mail-ru/2023_1_4from5/internal/pkg/notifications/usecase"
...
type PostHandler struct {
	...
	notificationApp *usecase.NotificationApp
}

func NewPostHandler(auc generatedAuth.AuthServiceClient, csc generatedCreator.CreatorServiceClient, logger *zap.SugaredLogger, app *usecase.NotificationApp) *PostHandler {
	return &PostHandler{
		authClient:      auc,
		creatorClient:   csc,
		logger:          logger,
